...
import { InventoryCommandController } from "./modules/inventory/controllers/inventorycommand.controller";
import { InventoryModule } from "./modules/inventory/modules/inventory.module";
import { CqrsModule } from "@nestjs/cqrs";
import { AppDataSource, initializeDatabase } from "./data-source";
import { InventoryQueryController } from "./modules/inventory/controllers/inventoryquery.controller";
import { GraphQLModule } from "@nestjs/graphql";
import { ApolloDriver, ApolloDriverConfig } from "@nestjs/apollo";
import GraphQLJSON from "graphql-type-json";
import { InventoryCommandService } from "./modules/inventory/services/inventorycommand.service";
import { InventoryQueryService } from "./modules/inventory/services/inventoryquery.service";
import { CacheModule } from "@nestjs/cache-manager";
import { LoggingModule } from "./modules/inventory/modules/logger.module";
...
@Module({
  imports: [
    ...
    /**
     * Módulos Inventory de la aplicación
     */
    CqrsModule,
    HorizontalModule,
    InventoryModule,
  ...
  /**
   * Controladores de Inventory
   *
   * Registro de controladores a nivel de aplicación.
   */
  controllers: [
  //No se recomienda habilitar los controladores si ya fueron declarados en el módulo: InventoryModule
  /*
  ...
  */
  ...
  /**
   * Proveedores (Servicios, Repositorios, etc.) de Inventory
   *
   ...
   */
  exports: [InventoryCommandService, InventoryQueryService,LoggerService],
})
export class InventoryAppModule implements OnModuleInit {
  /**
