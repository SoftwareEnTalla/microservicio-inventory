...
import { CreateInventoryReservationCommand } from "../createinventoryreservation.command";
...
export class CreateInventoryReservationHandler
  implements ICommandHandler<CreateInventoryReservationCommand>
{
  ...
  async execute(command: CreateInventoryReservationCommand) {
