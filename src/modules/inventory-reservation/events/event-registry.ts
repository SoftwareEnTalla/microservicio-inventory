...
import { InventoryReservationCreatedEvent } from './inventoryreservationcreated.event';
import { InventoryReservationUpdatedEvent } from './inventoryreservationupdated.event';
import { InventoryReservationDeletedEvent } from './inventoryreservationdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'inventory-reservation-created': createEventDefinition('inventory-reservation-created', InventoryReservationCreatedEvent, EVENT_DEFINITION_OVERRIDES['inventory-reservation-created']),
  'inventory-reservation-updated': createEventDefinition('inventory-reservation-updated', InventoryReservationUpdatedEvent, EVENT_DEFINITION_OVERRIDES['inventory-reservation-updated']),
  'inventory-reservation-deleted': createEventDefinition('inventory-reservation-deleted', InventoryReservationDeletedEvent, EVENT_DEFINITION_OVERRIDES['inventory-reservation-deleted']),
