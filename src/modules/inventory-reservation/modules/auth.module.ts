...
@Module({
  controllers: [InventoryReservationCommandController],
  providers: [
  ...
  exports: [InventoryReservationAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthInventoryReservationModule {}
