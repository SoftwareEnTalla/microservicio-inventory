...
import { logger } from '@core/logs/logger';
  ...
  export class InventoryReservationRepository {
    ...
    async findAndCount(where?: Record<string, any>): Promise<[InventoryReservation[], number]> {
      logger.info('Ready to findByField InventoryReservation on repository:',where);
    ...
    async update(
        ...
        logger.info('Updated instance of InventoryReservation with id:  was finded on repository:', instance);
