...
import { GetInventoryByFieldQuery } from '../getinventorybyfield.query';
import { InventoryQueryService } from '../../services/inventoryquery.service';

@QueryHandler(GetInventoryByFieldQuery)
export class GetInventoryByFieldHandler implements IQueryHandler<GetInventoryByFieldQuery> {
  constructor(private readonly queryService: InventoryQueryService) {}

  async execute(query: GetInventoryByFieldQuery) {
